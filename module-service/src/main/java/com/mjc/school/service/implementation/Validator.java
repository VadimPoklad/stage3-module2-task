...
public class Validator {
    public void validateInput(ModelDtoInterface modelDtoInterface) throws Exception {
        Field[] fields = modelDtoInterface.getClass().getDeclaredFields();
        for (Field field : fields) {
            Size annotation = field.getAnnotation(Size.class);
            if(annotation != null){
                field.setAccessible(true);
                String str = (String) field.get(modelDtoInterface);
